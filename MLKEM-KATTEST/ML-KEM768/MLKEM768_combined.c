...
int main()
{
	...
	uint8_t* pk = (uint8_t*)malloc(PQCLEAN_MLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES);	//PQCLEAN_KYBER768_CLEAN_CRYPTO_PUBLICKEYBYTES -> 3 * 384 + 32
	uint8_t* sk = (uint8_t*)malloc(PQCLEAN_MLKEM768_CLEAN_CRYPTO_SECRETKEYBYTES);	//PQCLEAN_KYBER768_CLEAN_CRYPTO_SECRETKEYBYTES -> (3 * 384) + (3 * 384 + 32) + (2 * 32)
	...
	// for (int i = 0; i < PQCLEAN_MLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES; i++) {
	// 	printf("%02X", pk[i]);
	// }
	// printf("\n");
	// for (int i = 0; i < PQCLEAN_MLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES; i++) {
