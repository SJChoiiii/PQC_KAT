...
int main()
{
	...
	uint8_t* pk = (uint8_t*)malloc(PQCLEAN_MLKEM1024_CLEAN_CRYPTO_PUBLICKEYBYTES);	//PQCLEAN_KYBER768_CLEAN_CRYPTO_PUBLICKEYBYTES -> 3 * 384 + 32
	uint8_t* sk = (uint8_t*)malloc(PQCLEAN_MLKEM1024_CLEAN_CRYPTO_SECRETKEYBYTES);	//PQCLEAN_KYBER768_CLEAN_CRYPTO_SECRETKEYBYTES -> (3 * 384) + (3 * 384 + 32) + (2 * 32)
